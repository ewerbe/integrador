...
<div>
    ...
    <form action="/cadastro-exposicao.action" method="get">
...
<div align="center" style="width: 100%;">
    <div style="display: flex; flex-wrap: wrap;">
        <c:forEach var="exposicao" items="${exposicoes}">
            <div style="flex-direction: row; width: 50%;">
                    <%--                <img src="data:image/png;base64,${obra.getImagemString()}" alt="" width="80%;">--%>
                <img src="/expo-banner-view.action?id=${exposicao.getId()}" alt="" width="80%;">
                <div class="card-body bg-dark" style="width: 80%; margin-bottom: 5%; :hover{ width: 90%;}">
                    <h5 class="card-title text-light" style="width: 80%;">${exposicao.getTitulo()}</h5>
<%--                    <p class="card-text text-light" style="width: 80%;">Artista: ${obra.getArtista().getNome()}<br>--%>
<%--                        Ano: ${obra.getAno()}</p>--%>
                    <form method="post">
                        <button type="submit" formaction="/obra/editar-exposicao.action?id=${exposicao.getId()}" class="btn btn-outline-info"
