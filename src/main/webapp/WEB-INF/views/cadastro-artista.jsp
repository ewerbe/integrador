...
<form id="cadastroArtista">
    ...
    <div id="formContainer" style="width: 500px; margin: auto;">
        ...
        <div class="mb-3" align="left">
            ...
            <input type="number" min="1900" max="2022" maxlength="4" class="form-control bg-dark" id="anoNascimentoArtista" name="anoNascimentoArtista"
        ...
        <div class="mb-3" align="left">
            ...
            <input type="number" min="1900" max="2022" maxlength="4" size="4" class="form-control bg-dark" id="anoMorteArtista" name="anoMorteArtista"
