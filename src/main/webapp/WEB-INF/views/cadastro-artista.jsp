...
<form id="cadastroColaborador" action="/artista/salvar-artista.action" method="post">
    ...
    <div id="formContainer" style="width: 500px; margin: auto;">
        ...
        <div class="mb-3" align="left">
            <label for="nacionalidadeArtista" class="form-label" style="color: #262630;
                   font-weight: bold;">nacionalidade</label>
            <input type="text" class="form-control bg-dark" id="nacionalidadeArtista" name="nacionalidadeArtista"
                   value="${artista.getNacionalidade()}"
                   placeholder="nacionalidade" style="color: antiquewhite;"
                   required>
        </div>
        <div class="mb-3" align="left">
